document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("jgnoRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("jgnoRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("jgnoRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("jgnoRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("jgnoRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("jgnoRecords", JSON.stringify(newRecord));
    getData();
}