document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("chmRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("chmRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("chmRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("chmRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("chmRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("chmRecords", JSON.stringify(newRecord));
    getData();
}