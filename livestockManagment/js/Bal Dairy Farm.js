document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("balRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("balRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("balRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("balRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("balRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("balRecords", JSON.stringify(newRecord));
    getData();
}