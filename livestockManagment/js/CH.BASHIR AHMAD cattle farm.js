document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("cbaRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("cbaRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("cbaRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("cbaRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("cbaRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("cbaRecords", JSON.stringify(newRecord));
    getData();
}