document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("srbulndRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("srbulndRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("srbulndRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("srbulndRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("srbulndRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("srbulndRecords", JSON.stringify(newRecord));
    getData();
}