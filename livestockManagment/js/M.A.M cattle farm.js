document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("mamRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("mamRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("mamRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("mamRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("mamRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("mamRecords", JSON.stringify(newRecord));
    getData();
}