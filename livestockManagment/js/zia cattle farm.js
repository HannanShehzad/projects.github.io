document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("ziaRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("ziaRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("ziaRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("ziaRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("ziaRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("ziaRecords", JSON.stringify(newRecord));
    getData();
}