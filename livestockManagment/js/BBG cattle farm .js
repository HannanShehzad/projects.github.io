document.getElementById("contForm").addEventListener('submit', function(e){
    ...
    {
        let record = localStorage.getItem("bbgRecords");
        ...
        if(record == null)
        {
            ...
            records.push(rcd);
            localStorage.setItem("bbgRecords", JSON.stringify(records));
        ...
        else
        {
            ...
            if(oldRecord)
            {
                ...
                localStorage.setItem("bbgRecords", JSON.stringify(pRecord));
...
function getData()
{
    let cont = JSON.parse(localStorage.getItem("bbgRecords"));
    var html = '';
...
{
    let record = JSON.parse(localStorage.getItem("bbgRecords"));
...
function deleteRecord(id)
{
    ...
    localStorage.setItem("bbgRecords", JSON.stringify(newRecord));
    getData();
}